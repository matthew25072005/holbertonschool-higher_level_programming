...
- Handle the file operations using the `with` statement to ensure proper resource management.
...
def write_file(filename="", text=""):
    ...
    Args:
        filename (str): The name of the file to write to. If no filename is provided,
                        an empty string is used, which would typically result in an error.
